...
/**
 * @brief saneClose 关闭扫描设备
 * @param sane_handle 扫描句柄
 */
static void saneClose(SANE_Handle sane_handle)
{
    sane_close(sane_handle);
}

/**
 * @brief saneExit 释放所有扫描资源
 */
static void saneExit()
{
    sane_exit();
}

/**
 * @brief checkSearchSaneDevices可以借此整理出未识别设备的情况
 * @return 检查情况返回值
 */
